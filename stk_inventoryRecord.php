    ...
    <div class="container">
        ...
        <table cellspacing="0" >
            ...
            <tbody>
               ...
               <td> <!-- <td><a href="read.php?productId=?php echo $row['productId'];?>">Read</a> -->
                <a id="delete" href="delete.php?productId=?php echo $row['productId'];?>">Delete</a> 
                <a id="update" href="update.php?productId=?php echo $row['productId'];?>">Update</a>
                </td>
                </tr>
                <?php
                     }
